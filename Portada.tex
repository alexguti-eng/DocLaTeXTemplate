...
\usepackage{ccicons} % Para logotipos Creative Commons
...
\newcommand{\Licencia}{CC BY-SA 4.0}

\newcommand{\Portada}{ %
    \thispagestyle{empty}
    \ULCornerWallPaper{1}{imagenes/Portada_Roja.pdf}
    \begin{textblock*}{18.45cm}(1.4cm,12cm) 
        \centering
        {\fontsize{26}{38}\selectfont \textbf{\color{purple}\TituloProyecto}}
      \vspace{.5cm}
      ...
      \begin{figure}
        \centering
        \includegraphics[width=.2\textwidth]{imagenes/Logo.jpg}
      \end{figure}
    \end{textblock*}
    ~
    \clearpage
