...
% ============================================================|
%                                                             |
% Plantilla para Proyecto personal v1.0                       |
%                                                             |
%    - A4 con márgenes de 2.5cm                               |
%    - Intelineado de 1.5 líneas                              |
%    - Primera línea de cada párrafo con sangrado             |
%    - Fuente Arial de 12pt                                   |
%    - Cabecera con nombre de autor y título del proyecto     |
%    - Pie con nº de página                                   |
%    - Portada propuesta (puedes cambiarla por una propia)    |
%                                                             |
% 2026/05/29 - Francisco Charte Ojeda - Versión inicial       |
%                                                             |
...
% ==== Introducir aquí el nombre del autor
\def\Autor{Nombre1 Nombre2 Apellido1 Apellido2}

% ==== Introducir aquí el título de completo y abreviado (para las cabeceras) del Proyecto
\def\TituloProyecto{Título del Proyecto}
\def\TituloAbreviado{Título abreviado para el encabezado}

% ==== Introducir aquí la fecha de presentación del Proyecto en el formato día/mes/año
\def\Fecha{31/5/2026}
...
\begin{center}
{\color{flashwhite} Generado con la plantilla \LaTeX \textit{Proyecto personal - v1.0} \par Licencia CC0 1.0 Universal (CC0 1.0) - Alejandro G. Gutiérrez}
\end{center}
